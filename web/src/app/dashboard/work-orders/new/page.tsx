      ...
      <div className="max-w-[680px] mx-auto space-y-6">
        ...
        <div className="bg-surface-container-lowest border border-outline-variant rounded-[12px] shadow-sm p-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className={labelCls}>{lang === 'ar' ? 'الموقع' : 'Site / Location'}</label>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className={labelCls}>{lang === 'ar' ? 'تعيين إلى' : 'Assign To'}</label>
              ...
              <div>
                <label className={labelCls}>{lang === 'ar' ? 'ساعات الخدمة' : 'SLA (hours to resolve)'}</label>
            ...
            <div>
              <label className={labelCls}>{lang === 'ar' ? 'تاريخ الاستحقاق' : 'Due Date'}</label>
              <input name="due_at" type="datetime-local" value={form.due_at} onChange={handleChange} className={inputCls} />
            </div>
            ...
            <div className="bg-surface-container-low border border-outline-variant/30 rounded-xl p-4">
              ...
              {form.is_recurring === 'true' && (
                <div>
                  ...
                  <select name="recurrence_frequency" value={form.recurrence_frequency} onChange={handleChange} className={inputCls}>
